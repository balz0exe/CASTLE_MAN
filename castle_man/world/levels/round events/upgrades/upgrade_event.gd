...
func _ready() -> void:
	...
	upgrades = [
		...
		{name = "a gun", color = Color.YELLOW, script = load("res://world/levels/round events/upgrades/upgrade_scripts/a_gun.gd"), weight = 0.5, cost = 500, stackable = true},
		...
		{name = "sekhmet's staff", color = Color.YELLOW, script = load("res://world/levels/round events/upgrades/upgrade_scripts/sekhmet's staff.gd"), weight = 4, cost = 100, stackable = true},
	]
